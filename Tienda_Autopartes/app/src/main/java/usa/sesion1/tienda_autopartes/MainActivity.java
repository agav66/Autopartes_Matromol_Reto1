...
public class MainActivity extends AppCompatActivity  {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.Productos) {
            Toast.makeText(getApplicationContext(),"Oprimio Opcion Productos", Toast.LENGTH_LONG ).show();
            Intent segundaPantalla = new Intent(this, MainActivity2.class);
            startActivity(segundaPantalla);
        }
        if (id == R.id.Servicios) {
            Toast.makeText(getApplicationContext(),"Oprimio Opcion Servicios", Toast.LENGTH_LONG ).show();
            Intent terceraPantalla = new Intent(this, MainActivity3.class);
            startActivity(terceraPantalla);
        }
        if (id == R.id.Sucursales) {
            Toast.makeText(getApplicationContext(),"Oprimio Opcion Sucursales", Toast.LENGTH_LONG ).show();
