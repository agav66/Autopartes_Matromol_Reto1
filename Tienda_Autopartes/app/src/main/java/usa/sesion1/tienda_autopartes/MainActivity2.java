...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.espejo_talvo, getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.martillo_elite_seguridad, getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.lampara_minikenwort_89, getTheme());
