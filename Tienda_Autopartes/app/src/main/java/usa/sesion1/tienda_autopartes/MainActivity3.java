...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.inyeccion_plastico, getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.ensamble_producto, getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.transporte_ejecutivos, getTheme());
